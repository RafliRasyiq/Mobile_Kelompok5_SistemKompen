...
class _DataListScreenState extends State<DataListScreen> {
  ...
  Future<void> fetchAllData() async {
    final url = Uri.parse(Config.dosen_kompen_selesai_endpoint);
    try {
...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  void fetchTaskDetail() async {
    final url = Uri.parse(Config.dosen_show_kompen_selesai_endpoint);
    try {
  ...
  void updateStatusTerima() async {
    final url = Uri.parse(Config.dosen_update_kompen_selesai_endpoint);
    try {
      final response = await http.post(
        url,
        headers: {
