...
import 'package:sistem_kompen/controller/mhs_kompen.dart';
import 'package:sistem_kompen/core/shared_prefix.dart';

class DetailMahasiswaKompen extends StatefulWidget {
  final String token;
  final String id;

  const DetailMahasiswaKompen(
      {super.key, required this.token, required this.id});

  @override
  _DetailKompenPageState createState() => _DetailKompenPageState();
}

class _DetailKompenPageState extends State<DetailMahasiswaKompen> {
